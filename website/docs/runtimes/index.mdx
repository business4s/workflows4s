...
<table>
    ...
    <tr>
        <td><code>SqliteRuntime</code></td>
        <td>Uses SQLite for persistence, with no in-memory state management.</td>
        <td>
            <ul>
                <li>Simplicity</li>
            </ul>
...
See [Wake-Ups](./04-knocker-uppers.md) for additional details.
