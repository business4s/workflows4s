...
Stateless retries are simple and easy to use. They allow rescheduling the wakeup but without tracking any state like attempt count,
...
Moreover,
this approach allows you to recover from errors because it produces events and events can modify the workflow state.
