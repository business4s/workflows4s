...
When drafting workflows that need checkpointing and recovery, you can use the draft API.

### Draft Checkpoint
```scala file=./main/scala/workflows4s/example/docs/DraftCheckpointExample.scala start=start_draft_checkpoint end=end_draft_recovery
