...
import workflows4s.runtime.{InMemoryConcurrentRuntime, InMemoryConcurrentWorkflowInstance, InMemorySynchronizedRuntime, InMemorySynchronizedWorkflowInstance}
