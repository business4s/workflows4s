...
object ForkBuilder {
  ...
  trait Step0[Ctx <: WorkflowContext]() {
    ...
    case class ForkBuilder[-In, +Err, +Out <: WCState[Ctx]](branches: Vector[WIO.Branch[IO, In, Err, Out, Ctx, ?]], name: Option[String]) {
      def onSome[T, Err1 >: Err, Out1 >: Out <: WCState[Ctx], In1 <: In](cond: In1 => Option[T])(
          wio: WIO[IO, T, Err1, Out1, Ctx],
          name: String = null,
      ...
      def matchCondition[T, Err1 >: Err, Out1 >: Out <: WCState[Ctx], In1 <: In](condition: In1 => Boolean, name: String = null)(
          onTrue: WIO[IO, In1, Err1, Out1, Ctx],
          onFalse: WIO[IO, In1, Err1, Out1, Ctx],
      ): WIO[IO, In1, Err1, Out1, Ctx] = WIO.Fork(
        Vector(
      ...
      def addBranch[T, Err1 >: Err, Out1 >: Out <: WCState[Ctx], In1 <: In](
          b: WIO.Branch[IO, In1, Err1, Out1, Ctx, ?],
      ...
      def done: WIO[IO, In, Err, Out, Ctx] = WIO.Fork(branches, name, None)
    }
