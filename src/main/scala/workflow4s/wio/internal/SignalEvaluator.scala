...
object SignalEvaluator {
  ...
  def handleSignal[Ctx <: WorkflowContext, Req, Resp, In, Out <: Ctx#State](
  ...
  private class SignalVisitor[Ctx <: WorkflowContext, Resp, Err, Out <: Ctx#State, In, Req](
    ...
    def recurse[I1, E1, O1 <: Ctx#State](wio: WIO[I1, E1, O1, Ctx], s: I1): SignalVisitor[Ctx, Resp, E1, O1, I1, Req]#Result =
